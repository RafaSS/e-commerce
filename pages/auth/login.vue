        ...
        <VeeForm @submit="onSubmit" :validation-schema="schema" v-slot="{ errors, isSubmitting }">
          <div class="space-y-4">
            <div class="space-y-2">
              ...
              <VeeField id="email" name="email" type="email" placeholder="Enter your email" autocomplete="email" :class="[
            ...
            <div class="space-y-2">
              ...
              <VeeField id="password" name="password" type="password" placeholder="Enter your password"
            ...
            <div>
              <Button type="submit" class="w-full" :is-loading="isSubmitting" :disabled="isSubmitting">
                Sign In
              </Button>
            </div>
            ...
            <div>
              <Button type="button" variant="outline" class="w-full" @click="signInWithGoogle" :disabled="isSubmitting">
...
import { useSupabaseAuthClient, useSupabaseUser } from '#auth'
