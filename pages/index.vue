<template>
  <div>
    ...
    <section class="relative overflow-hidden bg-gray-900 text-white">
      <div
        class="absolute inset-0 bg-gradient-to-r from-black to-transparent opacity-80"
      ></div>
      <div
        class="absolute inset-0 bg-cover bg-center"
        style="
          background-image: url('https://images.unsplash.com/photo-1607082349566-187342175e2f?q=80&w=2070');
        "
      ></div>
      <div
        class="container relative z-10 mx-auto flex min-h-[70vh] flex-col items-center justify-center px-4 py-16 text-center md:px-8"
      >
        <h1
          class="mb-6 text-4xl font-bold leading-tight tracking-tighter md:text-5xl lg:text-6xl"
        >
        ...
        >
          ...
          <NuxtLink to="/about">
            <Button
              size="lg"
              variant="outline"
              class="w-full bg-background/20 sm:w-auto"
              >Learn More</Button
            >
          </NuxtLink>
        </div>
    ...
    <section class="bg-muted py-16">
      <div class="container mx-auto">
        <h2 class="mb-8 text-center text-3xl font-bold tracking-tight">
          Shop by Category
        </h2>
      ...
      <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
        <div class="flex flex-col items-center text-center">
          ...
          <p class="text-muted-foreground">
            Free shipping on orders over $50. Get your products delivered right
            to your doorstep.
          </p>
        </div>
        <div class="flex flex-col items-center text-center">
          ...
          <p class="text-muted-foreground">
            30-day return policy. Not satisfied with your purchase? Send it back
            hassle-free.
          </p>
        </div>
        <div class="flex flex-col items-center text-center">
          ...
          <p class="text-muted-foreground">
            Your payment information is always secure. We use industry-standard
            encryption.
          </p>
        </div>
      </div>
    ...
    <section class="bg-primary py-16 text-primary-foreground">
      <div class="container mx-auto">
        <div class="mx-auto max-w-xl text-center">
          ...
          <p class="mb-6">
            Stay updated with our latest offers, product launches, and exclusive
            deals.
          </p>
...
const categories = ref([
  ...
  },
  {
    ...
    slug: "clothing",
    image:
      "https://images.unsplash.com/photo-1556905055-8f358a7a47b2?q=80&w=2070",
  },
  {
    id: 3,
    name: "Home & Kitchen",
    slug: "home",
    image:
      "https://images.unsplash.com/photo-1583847268964-b28dc8f51f92?q=80&w=1974",
  },
  {
    id: 4,
    name: "Accessories",
    slug: "accessories",
    image:
      "https://images.unsplash.com/photo-1511499767150-a48a237f0083?q=80&w=1980",
  },
]);
</script>
