    ...
    <section class="bg-gray-100 py-12">
      <div class="container mx-auto px-4">
        <div class="max-w-3xl mx-auto text-center">
          ...
          <p class="text-lg text-gray-600 mb-8">Discover amazing products at unbeatable prices</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div class="bg-white p-6 rounded-lg shadow-sm flex items-center">
            ...
            <div>
              ...
              <p class="text-gray-600">Customer support all day</p>
            </div>
          </div>
          <div class="bg-white p-6 rounded-lg shadow-sm flex items-center">
            <div class="mr-4 text-blue-600">
            ...
            <div>
              <h3 class="font-semibold text-lg mb-1">Secure Payments</h3>
