<template>
  <div>
    <div class="max-w-5xl mx-auto">
      <h1 class="text-3xl font-bold mb-8 dark:text-white">Your Shopping Cart</h1>
      
      <div v-if="cartStore.cartIsEmpty" class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-sm text-center transition-colors">
        <div class="text-gray-400 dark:text-gray-500 mb-4">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
          </svg>
        </div>
        <h2 class="text-xl font-semibold mb-2 dark:text-white">Your cart is empty</h2>
        <p class="text-gray-600 dark:text-gray-300 mb-6">Looks like you haven't added any products to your cart yet.</p>
      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <li v-for="item in cartStore.items" :key="item.id" class="p-4">
                <div class="flex items-center space-x-4">
                  ...
                  <div class="flex items-center space-x-2">
                    ...
                    <span class="text-gray-700 dark:text-gray-300 w-6 text-center">{{ item.quantity }}</span>
        ...
        <div class="md:col-span-1">
          <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm sticky top-4 transition-colors">
            <h2 class="text-lg font-semibold mb-4 dark:text-white">Order Summary</h2>
            
            <div class="space-y-4">
              <div class="flex justify-between">
                <span class="text-gray-600 dark:text-gray-300">Subtotal ({{ cartStore.itemCount }} items)</span>
                <span class="font-medium dark:text-white">${{ cartStore.totalPrice.toFixed(2) }}</span>
              </div>
