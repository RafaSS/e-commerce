  ...
  <div class="container py-8">
    ...
    <div v-else class="grid gap-8 lg:grid-cols-3">
      ...
      <div class="lg:col-span-2">
        <VeeForm @submit="placeOrder" :validation-schema="schema" v-slot="{ errors, isSubmitting }">
          <div class="space-y-8">
            ...
            <div class="rounded-lg border p-6">
              ...
              <div class="space-y-4">
                ...
                <div class="space-y-2">
                  ...
                  />
                  <VeeErrorMessage name="address" class="text-xs text-red-500" />
                </div>
                
                <div class="space-y-2">
                  <label for="apartment" class="text-sm font-medium">Apartment, suite, etc. (optional)</label>
                  <VeeField
                    id="apartment"
                    name="apartment"
                    type="text"
                  ...
                  />
                  <VeeErrorMessage name="apartment" class="text-xs text-red-500" />
                </div>
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                  ...
                  <div class="space-y-2">
                    ...
                    />
                    <VeeErrorMessage name="state" class="text-xs text-red-500" />
                  </div>
                  <div class="space-y-2">
                    ...
                    />
                    <VeeErrorMessage name="postalCode" class="text-xs text-red-500" />
                  </div>
                </div>
                ...
                <div class="space-y-2">
                  ...
                  <VeeErrorMessage name="country" class="text-xs text-red-500" />
                </div>
            ...
            <div class="rounded-lg border p-6">
              ...
              <div class="space-y-4">
                <div class="space-y-2">
                  <label for="cardName" class="text-sm font-medium">Name on Card</label>
                  <VeeField
                    id="cardName"
                    name="cardName"
                    type="text"
                  ...
                  />
                  <VeeErrorMessage name="cardName" class="text-xs text-red-500" />
                </div>
                ...
                <div class="space-y-2">
                  ...
                  />
                  <VeeErrorMessage name="cardNumber" class="text-xs text-red-500" />
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                  <div class="space-y-2">
                    ...
                    />
                    <VeeErrorMessage name="expiryDate" class="text-xs text-red-500" />
                  </div>
                  <div class="space-y-2">
        ...
        <div class="sticky top-20 rounded-lg border p-6">
          ...
          <div class="divide-y">
            <div class="max-h-64 space-y-3 overflow-auto py-2">
              <div v-for="item in cartStore.items" :key="item.id" class="flex items-center space-x-4">
                <div class="h-16 w-16 flex-shrink-0 overflow-hidden rounded-md border">
          ...
          <div class="mt-4 rounded-md bg-muted p-4 text-sm">
            <p class="flex items-center">
              <Icon name="lucide:shield-check" class="mr-2 h-4 w-4 text-primary" />
...
onMounted(() => {
  ...
  if (!user.value) {
    router.push('/auth/login?redirect=/checkout&message=Please log in to complete checkout')
  }
})
