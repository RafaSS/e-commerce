  ...
  <div class="container py-8">
    ...
    <div v-else>
      ...
      >
        ...
        <NuxtLink to="/products" class="hover:text-foreground"
          >Products</NuxtLink
        >
        <Icon name="lucide:chevron-right" class="h-4 w-4" />
          ...
          <div class="space-y-2">
            ...
            <div class="flex items-center space-x-2">
              ...
              <span class="text-sm text-muted-foreground"
                >Ships in 1-2 business days</span
              >
            </div>
          </div>
            ...
            <div class="grid grid-cols-3 gap-4">
              ...
              <div class="flex flex-col items-center text-center">
                <Icon
                  ...
                  class="mb-2 h-5 w-5 text-primary"
                />
                <span class="text-xs text-muted-foreground"
                  >30 Days Easy Returns</span
                >
              </div>
              <div class="flex flex-col items-center text-center">
    ...
    const sampleProducts = [
      {
        ...
        description:
          "Experience premium sound quality with our wireless headphones. These over-ear headphones feature active noise cancellation, a comfortable fit for all-day wear, and up to 30 hours of battery life. Perfect for music lovers, travelers, and professionals alike.",
      },
      {
        id: 2,
        ...
        category: "clothing",
        description:
          "Made from 100% organic cotton, this t-shirt is both environmentally friendly and incredibly comfortable. Features a relaxed fit and is available in multiple colors. Perfect for everyday wear or casual outings.",
      },
      {
        id: 3,
        ...
        category: "electronics",
        description:
          "Stay connected and track your fitness with our latest smartwatch. Features heart rate monitoring, GPS tracking, water resistance up to 50 meters, and a battery life of up to 18 hours. Compatible with both iOS and Android devices.",
      },
      {
        id: 4,
        ...
        category: "home",
        description:
          "Elevate your living space with this modern coffee table. Made from high-quality materials with a sleek design that complements any decor. The spacious surface provides plenty of room for books, decor, and beverages.",
      },
      {
        id: 5,
        ...
        description:
          "Protect your eyes in style with these designer sunglasses. Featuring UV400 protection, polarized lenses, and a durable frame. The timeless design ensures you'll look fashionable for years to come.",
      },
    ];
